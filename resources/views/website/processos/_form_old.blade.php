<div>
    {{ Form::button('Sair', ['class' => 'btn btn-danger']) }}
</div>
...
<div class="row">
    @component('website.form-components._form_col_group',['class' => 'col-12 col-md-4'])
        {{ Form::label('pro_ema_ds_email1', 'E-mail 1', ['class' => 'control-label']) }}
        {{ Form::text('pro_ema_ds_email1', null, ['class' => 'form-control', 'id' => 'email1']) }}
    @endcomponent
    @component('website.form-components._form_col_group',['class' => 'col-12 col-md-4'])
        {{ Form::label('pro_ema_ds_email2', 'E-mail 2', ['class' => 'control-label']) }}
        {{ Form::text('pro_ema_ds_email2', null, ['class' => 'form-control', 'id' => 'email2']) }}
    @endcomponent
    @component('website.form-components._form_col_group',['class' => 'col-12 col-md-4'])
        {{ Form::label('pro_ema_ds_email3', 'E-mail 3', ['class' => 'control-label']) }}
        {{ Form::text('pro_ema_ds_email3', null, ['class' => 'form-control', 'id' => 'email3']) }}
    @endcomponent
</div>
<h5>Telefones</h5>
<hr class="line">
