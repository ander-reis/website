<div class="line-section" style="border-color: #6C757D"></div>
<h1 class="text-center">Fale com o SinproSP</h1>

<div class="row">

    <div class="col-12 col-sm-6 col-lg-3">
        <img src="{{ asset('images/layout-1/fale-com-o-sinpro/sindicalizar.jpg') }}" class="img-fluid" alt="">
        <div class="mt-2">
