    ...
    <div class="col-sm-12 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    <a href="{{ route('convencao.show', ['convencoes_entidade' => $entidade->id, 'convencao' => $entidade->convencoes[0]->id_convencao]) }}"
                        class="text-link">{{ $entidade->convencoes[0]->ds_titulo }}</a>
                </p>
