<div class="row">
    ...
    <div class="col-md-5">
        @component('admin.form-components._form_group',['field' => 'name'])
...
<div class="row">
    ...
    <div class="col-md-4">
        @component('admin.form-components._form_group',['field' => 'ds_data_nascimento'])
            {{ Form::label('ds_data_nascimento', 'Data de Nascimento', ['class' => 'control-label']) }}
            {{ Form::date('ds_data_nascimento', null, ['class' => 'form-control']) }}
        @endcomponent
    </div>
    <div class="col-md-2">
...
<div class="row">
    <div class="col-md-3">
        <div class="custom-control custom-checkbox">
            {{ Form::checkbox('pre', 1, null, ['class' => 'custom-control-input', 'id' => 'check_pre']) }}
